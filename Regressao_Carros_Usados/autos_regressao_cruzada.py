...
regressor = KerasRegressor(build_fn = criar_rede, batch_size = 300, epochs = 50)

resultados = cross_val_score(estimator = regressor, X = previsores, y = preco_real, cv = 5, scoring = 'neg_mean_absolute_error')
